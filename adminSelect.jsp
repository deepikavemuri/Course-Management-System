      ...
      <div class="row">     
         <div class="col-sm-4 col-md-6 col-lg-6" >
         	<form action="addNew" method="POST">			
      			<input type="text" class="form-control" name="FName" required="required" placeholder="Enter name"><br>
      			<input type="email" class="form-control" name="email" required="required" placeholder="Enter email"><br>
      			<input type="password" class="form-control" name="pwd" required="required" placeholder="Enter password"><br>
