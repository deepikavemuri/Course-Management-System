...
<form action="adminSelect.jsp" method="POST">
	...
	<button type="submit" class="btn btn-primary btn-lg" style="width:250px">Student</button><br><br><br>
</form>
<form action="adminSelect.jsp" method="POST">
	<input type="hidden" value="2" name="x">
	<button type="submit" class="btn btn-primary btn-lg" style="width:250px">Instructor</button><br><br><br>
</form>
<form action="adminRoom.jsp" method="POST">
	<button type="submit" class="btn btn-primary btn-lg" style="width:250px">Room</button>
</form>
</center>
